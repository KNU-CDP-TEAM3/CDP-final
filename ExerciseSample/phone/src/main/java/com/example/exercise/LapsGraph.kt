...
import com.example.exercise.databinding.LapsGraphBinding
...
class LapsGraph : AppCompatActivity(), CoroutineScope by MainScope(),
    ...
    var isrunning = false
    private lateinit var binding: LapsGraphBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = LapsGraphBinding.inflate(layoutInflater)
        ...
        if (!wearableDeviceConnected) {
            val tempAct: Activity = activityContext as LapsGraph
            //Couroutine
        ...
        des.setEnabled(true)
        des.setText("LapsRateGraph Ready")
        des.setTextSize(15f)
...
//            var binding : FragmentHomeBinding = FragmentHomeBinding.inflate(layoutInflater)
    ...
    private fun createSet(): LineDataSet {
        ...
        set.valueTextColor = ContextCompat.getColor(this,R.color.purple_700)
        set.color = ContextCompat.getColor(this,R.color.purple_700)
