...
import com.example.exercise.databinding.DistanceGraphBinding
...
class DistanceGraph  : AppCompatActivity(), CoroutineScope by MainScope(),
    ...
    var isrunning = false
    private lateinit var binding: DistanceGraphBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DistanceGraphBinding.inflate(layoutInflater)
        ...
        if (!wearableDeviceConnected) {
            val tempAct: Activity = activityContext as DistanceGraph
            //Couroutine
        ...
        des.setEnabled(true)
        des.setText("DistanceGraph Ready")
        des.setTextSize(15f)
...
//            var binding : FragmentHomeBinding = FragmentHomeBinding.inflate(layoutInflater)
                    ...
                    for(i in 0..s.length-1 step(1)){
                        if(s[i] == 'A'){
                            if(Count == 0){
                                ...
                                binding.distanceText.text = tempS
    ...
    private fun createSet(): LineDataSet {
        ...
        set.valueTextColor = ContextCompat.getColor(this,R.color.purple_500)
