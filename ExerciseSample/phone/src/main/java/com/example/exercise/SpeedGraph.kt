...
import com.example.exercise.databinding.SpeedGraphBinding
...
class SpeedGraph : AppCompatActivity(), CoroutineScope by MainScope(),
    ...
    var isrunning = false
    private lateinit var binding: SpeedGraphBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = SpeedGraphBinding.inflate(layoutInflater)
        ...
        if (!wearableDeviceConnected) {
            val tempAct: Activity = activityContext as SpeedGraph
            //Couroutine
...
//            var binding : FragmentHomeBinding = FragmentHomeBinding.inflate(layoutInflater)
    ...
    private fun createSet(): LineDataSet {
        ...
        set.valueTextColor = ContextCompat.getColor(this,R.color.teal_200)
        set.color = ContextCompat.getColor(this,R.color.teal_200)
