...
import com.example.exercise.databinding.CalorieGraphBinding
...
class CalorieGraph : AppCompatActivity(), CoroutineScope by MainScope(),
    ...
    var isrunning = false
    private lateinit var binding: CalorieGraphBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = CalorieGraphBinding.inflate(layoutInflater)
        ...
        if (!wearableDeviceConnected) {
            val tempAct: Activity = activityContext as CalorieGraph
            //Couroutine
        ...
        des.setEnabled(true)
        des.setText("CalorieGraph Ready")
        des.setTextSize(15f)
...
//            var binding : FragmentHomeBinding = FragmentHomeBinding.inflate(layoutInflater)
                    ...
                    for(i in 0..s.length-1 step(1)){
                        if(s[i] == 'A'){
                            if(Count == 0){
                                ...
                                binding.calorieText.text = tempS
                                runOnUiThread { addEntry(tempS.toDouble()) }
                            }
                            else if(Count == 2){
    ...
    private fun createSet(): LineDataSet {
        ...
        set.valueTextColor = ContextCompat.getColor(this,R.color.purple_200)
        set.color = ContextCompat.getColor(this,R.color.purple_200)
